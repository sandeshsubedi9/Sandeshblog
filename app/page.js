...
export default function Home() {
  ...
  return (
    <main>
      <section className="w-[90vw] container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center">
        <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
          <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
            A <span className="font-semibold"> Free Blog </span> Website to <br className="hidden lg:block" /> cover news of <span className="font-semibold underline decoration-primary"><span ref={el} /></span>
          </h1>
          <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
            A Free blog website that<br className="hidden lg:block" /> aim to tell the story around the Tech world
          </p>
          ...
          <Link href="/blog"><button type="button" className=" mt-4 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Read our Blogs </button></Link>
